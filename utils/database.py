...
class Database:
    ...
    # def get_products(self, cat_id=None):
    #     # If cat_id is provided, retrieve products for that category
    #     if cat_id is not None:
    #         # Query the database for products based on the category ID
    #         # Example: SELECT * FROM products WHERE category_id = cat_id
    #         # Replace this with your actual query
    #         products = self.query_products_by_category(cat_id)
    #     else:
    #         # If no cat_id is provided, retrieve all products
    #         # Example: SELECT * FROM products
    #         # Replace this with your actual query
    #         products = self.query_all_products()
    #
    #     return products
